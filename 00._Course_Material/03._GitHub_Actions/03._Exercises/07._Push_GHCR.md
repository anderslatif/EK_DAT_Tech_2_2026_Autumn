  ...
  build-and-push:
    ...
    steps:
      ...
      - name: Log in to GitHub Container Registry
        uses: docker/login-action@dbcb813823bdd20940b903addbd779551569679f # v4.6.0   Jul 29th 2026
        with:
      ...
      - name: Extract metadata (tags, labels)
        id: meta
        uses: docker/metadata-action@dc802804100637a589fabce1cb79ff13a1411302 # v6.2.0   Jul 2nd 2026
        with:
      ...
      - name: Build and push
        uses: docker/build-push-action@53b7df96c91f9c12dcc8a07bcb9ccacbed38856a # v7.3.0   Jul 1st 2026
        with:
          context: .
          push: true
...
```bash
git add .
git commit -m "Added GitHub Action to push Docker image to GHCR"
git push
```
...
6. If everything is set up correctly, the Docker image should be pushed to the GitHub Container Registry. You can verify this by going to the "Packages" section of your repository (right sidebar) or under the "Packages" tab on your GitHub profile page.
