...
Enter the public IP address into your browser but first you must allow traffic on port `80`.

Here is a [tutorial](https://github.com/anderslatif/EK_Azure/blob/main/tutorials/create_a_VM/port_rules/adding_port_rules.md).

To test whether the application is running correctly, open a web browser and navigate to the public IP address of the app VM. You should see the frontend application running. 
