...
Extract the environment variables into a separate file, to keep the `compose.yaml` file free of sensitive information.

## Step 1: Create a `.env` file

Create a new file named `.env` in the same directory as your `compose.yaml` file. This file will contain all the environment variables for your services.
...
## Step 2: Using environment variables in `compose.yaml`

Now that we have our environment variables defined in the `.env` file, we can reference them in our `compose.yaml` file.
