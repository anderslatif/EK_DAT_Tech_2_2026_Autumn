...
Example of a script that compiles and starts a Maven project:
...
**Dependency Management**: Containers package an application and its dependencies together.
...
- **Dockerfile**: Plaintext file that contains instructions to build an image (base image, deps, config).
